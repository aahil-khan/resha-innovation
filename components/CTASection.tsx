...
export function CTASection() {
  ...
  return (
    <section className="relative py-24 px-6 overflow-hidden" style={{ background: '#E87722' }}>
      {/* Background pattern */}
      ...
      <div className="relative max-w-4xl mx-auto text-center z-10">
        ...
        <div className="flex justify-center mb-6">
          <svg width="48" height="48" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg" opacity="0.85">
            ...
            {[0,45,90,135,180,225,270,315].map((angle, i) => (
              <line key={i} x1="24" y1="2" x2="24" y2="10" stroke="white" strokeWidth="1.2"
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center mb-8">
          <Link href="/onboard" className="inline-flex items-center justify-center gap-2 px-10 py-4 bg-forest text-white rounded-xl font-bold text-lg hover:bg-forest-dark transition-all duration-300 shadow-lg hover:shadow-xl">
            {cta.button_text}
          </Link>
          <Link href="/network" className="inline-flex items-center justify-center gap-2 px-10 py-4 border-2 border-white/60 text-white rounded-xl font-semibold text-base hover:bg-white/10 transition-all duration-300">
            {cta.secondary_link}
          </Link>
        </div>
